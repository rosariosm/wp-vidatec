	<?php
		...
		*/
		...
		$nt_big_border_menu_item_name = rwmb_meta( 'nt_big_border_section_name' );
		$nt_big_border_menu_item_url = rwmb_meta( 'nt_big_border_section_url' );
		$nt_big_border_menutype = rwmb_meta( 'nt_big_border_menutype' );
		...
		$nt_big_border_nav_offset = $nt_big_border_nav_offset != '' && $nt_big_border_nav_offset != '0' ? ' data-scroll-offset="'.$nt_big_border_nav_offset.'"' : '';
		...
		<div class="<?php echo esc_attr( $nt_big_border_nav_container ); ?>">
			...
			<?php endif; ?>
				<?php
					...
					if( $nt_big_border_menutype  == 'm' &&  $nt_big_border_menu_item_name !='' ){
						echo '<ul data-offcanvass="yes" class="primary-menu">';

							foreach (array_combine($nt_big_border_menu_item_name, $nt_big_border_menu_item_url) as $name => $url) {
