...
if(!class_exists('Nt_Big_Border_Aq_Resize')) {
    class Aq_Exception extends Exception {}

    class Nt_Big_Border_Aq_Resize {
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                error_log('Nt_Big_Border_Aq_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('nt_big_border_aq_resize')) {
    function nt_big_border_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $nt_big_border_aq_resize = Nt_Big_Border_Aq_Resize::getInstance();
        return $nt_big_border_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}